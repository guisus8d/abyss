...
export default function PostImageScreen({ navigation }) {
  ...
  async function handlePost() {
    ...
    try {
      ...
      if (image.uri.startsWith('blob:') || image.uri.startsWith('data:') || image.uri.startsWith('http')) {
        ...
        // ✅ Expo Go native: uri tipo file:/// o content://
      ...
      // ✅ FIX: usar postFormData (fetch nativo) — axios rompe FormData en React Native
