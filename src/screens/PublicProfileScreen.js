    ...
    <View style={s.root}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={[s.hero, { paddingTop: insets.top + 100 }]}>
          ...
          >
            <AvatarWithFrame size={88} avatarUrl={profile?.avatarUrl} username={profile?.username} profileFrame={profile?.profileFrame} frameUrl={profile?.profileFrameUrl} bgColor="rgba(0,229,204,0.12)" />
          </TouchableOpacity>
