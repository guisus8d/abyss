...
const s = StyleSheet.create({
  ...
  adminBadge:     { backgroundColor:'rgba(0,200,150,0.15)', borderWidth:1, borderColor:'rgba(0,200,150,0.6)', borderRadius:6, paddingHorizontal:7, paddingVertical:2, marginLeft:5 },
