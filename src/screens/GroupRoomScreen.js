...
const s = StyleSheet.create({
  ...
  adminBadge:     { backgroundColor:'transparent', borderWidth:1.5, borderColor:'#00c896', borderRadius:20, paddingHorizontal:10, paddingVertical:3, marginLeft:6 },
  adminBadgeTxt:  { fontSize:11, color:'#00c896', fontWeight:'700' },
