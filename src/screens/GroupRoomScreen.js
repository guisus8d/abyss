...
const s = StyleSheet.create({
  ...
  adminBadge:     { backgroundColor:'#1a7a5e', borderRadius:4, paddingHorizontal:6, paddingVertical:2, marginLeft:6 },
  adminBadgeTxt:  { fontSize:10, color:'#ffffff', fontWeight:'600', letterSpacing:0.2 },
