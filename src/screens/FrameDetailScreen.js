    ...
    <View style={s.root}>
      ...
      <SafeAreaView style={s.safe}>
        ...
        <View style={s.preview}>
              ...
              <View style={{ width: AVATAR_SIZE, height: AVATAR_SIZE }}>
                ...
                {frame.imageUrl && (
                  <Image
                    ...
                    style={[StyleSheet.absoluteFill, { width: AVATAR_SIZE, height: AVATAR_SIZE }]}
                    resizeMode="contain"
                  />
                )}
              </View>
          ...
          {frame.description ? (
            <Text style={s.frameDesc}>{frame.description}</Text>
          ) : null}
...
const s = StyleSheet.create({
  ...
  frameName:    { color: colors.textHi, fontSize: 22, fontWeight: '800', textAlign: 'center', letterSpacing: 0.5 },
